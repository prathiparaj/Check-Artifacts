...
$source = "https://globalartifactstg.blob.core.windows.net/globalsoftwarelink4artifact/rubyinstaller-2.3.3-x64.exe"
...
if((Test-Path "$setupFolder\ansi160.zip") -eq $false)
{
        ...
        Download-File "https://globalartifactstg.blob.core.windows.net/globalsoftwarelink4artifact/ansi160.zip" "$setupFolder\ansi160.zip"  
}
