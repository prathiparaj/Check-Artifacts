...
if((Test-Path "$setupFolder\spring-boot-cli-1.5.9.RELEASE-bin (1).zip") -eq $false)
{
        ...
        Download-File "https://globalartifactstg.blob.core.windows.net/globalsoftwarelink4artifact/spring-boot-cli-1.5.9.RELEASE-bin%20(1).zip" "$setupFolder\spring-boot-cli-1.5.9.RELEASE-bin (1).zip"  
}
