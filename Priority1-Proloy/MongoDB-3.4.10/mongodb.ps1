...
if((Test-Path "$setupFolder\mongodb-win32-x86_64-enterprise-windows-64-3.4.10-signed.msi") -eq $false)
{
        ...
        Download-File "https://globalartifactstg.blob.core.windows.net/globalsoftwarelink4artifact/mongodb-win32-x86_64-enterprise-windows-64-3.4.10-signed.msi" "$setupFolder\mongodb-win32-x86_64-enterprise-windows-64-3.4.10-signed.msi"  
}
